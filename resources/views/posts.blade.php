...
<body>
    ...
    <div class="container" style="margin-top: 50px">
        <div class="row">
            <div class="col-md-12">
                <h4 class="text-center">PROJECT QUIZ 1 FACHRY - <a href="https://lms.smapluspgri.sch.id">lms.smapluspgri.sch.id</a></h4>
                            ...
                            <tbody id="table-posts">
                                ...
                                <tr id="index_{{ $post->id }}">
                                    ...
                                    <td class="text-center">
                                        <a href="javascript:void(0)" id="btn-edit-post" data-id="{{ $post->id }}" class="btn btn-primary btn-sm">PERBARUI</a>
